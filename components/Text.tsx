...
export function TextParagraph({ children }: { children: string }) {
    return (
        <span className="about-text-p m-0 text-start text-[15px] font-normal italic leading-[1.56em] tracking-wide text-neutral-600 dark:text-neutral-350 sm:text-[16px] lg:font-medium">
            {Parse(children)}
        </span>
    );
}
