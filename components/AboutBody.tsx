...
export function AboutBody() {
    return (
        <div className="justify-items-center justify-center sm:pl-2 lg:pl-7 mr-0 mt-6 flex-row items-center text-left lg:mt-4">
            <div className="m-0 mb-2 flex max-w-4xl flex-col flex-wrap items-start justify-center gap-y-6 overflow-hidden pr-0 text-left sm:mb-5">
                ...
                <div className="justify-center my-1 flex w-full flex-row items-start sm:mt-4 sm:pr-6">
