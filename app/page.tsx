...
export default async function AboutPage() {
    return (
        <section className="flex w-full h-full lg:pt-0">
            <div className="flex w-full h-full mx-auto flex-col items-center justify-center">
                <div className="relative h-full flex flex-col justify-start sm:justify-center mx-auto items-start overflow-auto px-[30px] max-w-5xl gap-y-[10px] lg:gap-y-[20px]">
