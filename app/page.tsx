...
export default async function AboutPage() {
	return (
		<section>
			<div className="relative flex flex-col sm:justify-start mx-auto items-start px-6 sm:px-8 sm:max-w-4xl gap-y-8 lg:gap-y-0 pt-16 sm:pt-20 pb-12">
