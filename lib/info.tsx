...
export const about_p = `<span class='name-highlight'>${name}</span>, self-taught <span class='large-highlight'>programmer</span>, <span class='large-highlight'>designer</span> and <a class="p-link large-highlight" rel=\"noopener noreferrer\" target=\"_blank\" href=\"https://www.reddit.com/user/bauera5/\">r/neography</a> hobbyist from <span class='large-highlight'> Dallas, TX </span>.`;
...
export const background_p = `I started my self-taught skills journey around 2010, initially focusing on graphic design and mastering <span class='large-highlight'>Photoshop</span>. In 2018, a computer engineer friend introduced me to programming, and it quickly became my passion. After some exploration, I think I \"settled into the design side\" of programming, combining my still expanding coding skills with a keen eye for aesthetics.`;

export const languages_h = `SKILLS:`;

export const languages_p = `In addition to loving <span class='large-highlight'>Swift</span> (and of course <span class='large-highlight'>SwiftUI</span>) for Apple products, I've worked a lot with both <span class='large-highlight'>JavaScript</span> and <span class='large-highlight'>TypeScript</span> to make universal dekstop apps and websites in <span class='large-highlight'>React</span> (<span class='large-highlight'>this website</span>), and I've explored the frontend framework <span class='large-highlight'>Qt</span> with <span class='large-highlight'>C++</span> to some degree. When I'm not using the tried and true <span class='large-highlight'>Electron</span> for the desktop, I'm trying to get the brand new framework <span class='large-highlight'>Tauri</span> to work for me and really master the <span class='large-highlight'>Rust</span> language. Aside from these languages and libraries for creating frontends, my main scripting language of choice is <span class='large-highlight'>Python</span>. Which I've used for tons of little things, including coding challenges like <span class='large-highlight'>Codewars</span> and <span class='large-highlight'>AdventOfCode</span>.`;

export const tools_h = `TOOLS:`;

export const tools_p = `For all my projects, I rely on <span class='large-highlight'>Figma </span> as my go-to tool for prototyping designs before transitioning to code. I also have years of experience with <span class='large-highlight'>Photoshop</span> and <span class='large-highlight'>Illustrator</span> as well. Additionally, I have some very minor familiarity with programs like <span class='large-highlight'>FontLab</span>, <span class='large-highlight'>FontForge</span> and <span class='large-highlight'>Calligraphr</span>, which I enjoy using for personal hobbies like creating constructed scripts.`;
