...
export const ui_tx4: IEntry = {
	...
	items: [
		{ type: "image", path: "/images/tx4-for-real/map.png", width: 2680, height: 1810 },
		{ type: "image", path: "/images/tx4-for-real/main.png", width: 2680, height: 1810 },
		{ type: "image", path: "/images/tx4-for-real/viewer.png", width: 2680, height: 1810 },
		{ type: "image", path: "/images/tx4-for-real/loading.png", width: 2680, height: 1810 },
	],
};
...
export const ui_comma_interface_challenge: IEntry = {
	...
	items: [
        { type: "image", path: "/images/comma-interface-challenge/home.png", width: 2160, height: 1080 },
        { type: "image", path: "/images/comma-interface-challenge/popup.png", width: 2160, height: 1080 },
        { type: "image", path: "/images/comma-interface-challenge/update.png", width: 2160, height: 1080 },
        { type: "image", path: "/images/comma-interface-challenge/maps.png", width: 2160, height: 1080 },
    ],
};
...
export const ui_intros: IEntry = {
	...
	items: [
		{ type: "image", path: "/images/tro-io/ImagePage.png", width: 1920, height: 947 },
		{ type: "image", path: "/images/tro-io/SimilarImages.png", width: 1920, height: 1189 },
		{ type: "image", path: "/images/tro-io/Banner.png", width: 1920, height: 368 },
		{ type: "image", path: "/images/tro-io/intros.png", width: 2560, height: 1440 },
		{ type: "image", path: "/images/tro-io/Titlebars.png", width: 1920, height: 1074 },
	],
};
...
export const ui_opgg_spectate: IEntry = {
	...
	items: [
		{ type: "image", path: "/images/concepts/pros/liiv.png", width: 2208, height: 999 },
		{ type: "image", path: "/images/concepts/pros/mundo.png", width: 2415, height: 843 },
		{ type: "image", path: "/images/concepts/pros/t1.png", width: 2300, height: 694 },
		{ type: "image", path: "/images/concepts/OPGG.png", width: 1575, height: 885 },
	],
};
...
export const ui_lol_icon_tool: IEntry = {
	...
	items: [{ type: "image", path: "/images/concepts/LoL.png", width: 1794, height: 1009 }],
};
...
export const painting_cybertruck_texas: IEntry = {
	...
	items: [
        { type: "image", path: "/images/drawings/cybertruck-texas/cybertruck-texas.png", width: 5120, height: 2880, },
        { type: "image", path: "/videos/cybertruck-texas-timelapse.mp4", width: 1920, height: 1080 },
    ],
};
...
export const painting_cybertruck: IEntry = {
	...
	items: [
        { type: "image", path: "/images/drawings/cybertruck/cybertruck-red.png", width: 2174, height: 2933, },
        { type: "image", path: "/images/drawings/cybertruck/cybertruck-green.png", width: 2174, height: 2933, },
        { type: "image", path: "/images/drawings/cybertruck/cybertruck-yellow.png", width: 2174, height: 2933, },
        { type: "image", path: "/videos/cybertruck-timelapse.mp4", width: 1440, height: 1080 },
    ],
};
...
export const painting_power_lines: IEntry = {
	...
	category: "photoshop",
    aspectRatio: true,
    useLinkPreview: { type: "image", path: "/images/drawings/power-lines/power-lines.png", width: 3000, height: 4000, },
    thumbnail: {
        type: "image",
...
export const logo_tdb: IEntry = {
    ...
    thumbnail: { type: "image", path: "/images/tdb-landing/tdb-landing-thumb.png", width: 857, height: 857, },
	items: [
        { type: "image", path: "/thumbnails/tdb-circle-thumb.png", width: 1024, height: 1024, },
        { type: "image", path: "/thumbnails/tdb-square-thumb.png", width: 1024, height: 1024, },
    ],
};
...
export const logo_tbab: IEntry = {
	...
	items: [
        { type: "image", path: "/thumbnails/tbab-thumb.png", width: 1024, height: 1024, },
    ],
};
...
export const logo_plan: IEntry = {
	...
	items: [
        { type: "image", path: "/images/concepts/pLan/pLan-logo.png", width: 1600, height: 1600 },
        { type: "image", path: "/images/concepts/pLan/pLan-x.png", width: 1168, height: 571 },
        { type: "image", path: "/images/concepts/pLan/pLan-mockup.png", width: 3840, height: 2160 }
    ],
};
...
export const logo_d: IEntry = {
    ...
    useLinkPreview: { type: "image", path: "/images/concepts/d/d-banner.png", width: 1764, height: 588, },
    thumbnail: { type: "image", path: "/images/concepts/d/o-thumb-1000.png", width: 1000, height: 1000, },
	items: [
        { type: "image", path: "/images/concepts/d/o-logo.png", width: 2571, height: 2571 },
        { type: "image", path: "/images/concepts/d/o-x-banner.png", width: 1797, height: 857 },
        { type: "image", path: "/images/concepts/d/d-logo.png", width: 2571, height: 2571 },
        { type: "image", path: "/images/concepts/d/d-x-banner.png", width: 1797, height: 857 },
        { type: "image", path: "/videos/d-timelapse.mp4", width: 1440, height: 1440 },
    ],
};
...
export const icons_rosetta: IEntry = {
    ...
    thumbnail: { type: "image", path: "/images/adobe-icons/rosetta-thumb.gif", width: 1024, height: 1024, },
	items: [
        { type: "image", path: "/images/adobe-icons/Photoshop.png", width: 4942, height: 2780 },
        { type: "image", path: "/images/adobe-icons/Illustrator.png", width: 4942, height: 2780 },
        { type: "image", path: "/images/adobe-icons/Bridge.png", width: 4942, height: 2780 },
        { type: "image", path: "/images/adobe-icons/Audition.png", width: 4942, height: 2780 },
        { type: "image", path: "/images/adobe-icons/InDesign.png", width: 4942, height: 2780 },
    ],
};
...
export const figma_tattoo: IEntry = {
    ...
    useLinkPreview: { type: "image", path: "/images/figma-tattoo/figma-tattoo-preview-flip.png", width: 1920, height: 384, },
    thumbnail: { type: "image", path: "/images/figma-tattoo/figma-tattoo-thumb.png", width: 1024, height: 1024, },
	items: [
        { type: "image", path: "/images/figma-tattoo/figma-tattoo-horizontal.png", width: 2488, height: 1781 },
        { type: "image", path: "/images/figma-tattoo/figma-tattoo-mockup.png", width: 2160, height: 2700 }
    ],
};
...
export const t_wear: IEntry = {
    ...
    thumbnail: { type: "image", path: "/images/t_wear/t!-thumb.gif", width: 857, height: 857, },
	items: [
        { type: "image", path: "/images/t_wear/t-wear-logos-2.jpg", width: 3152, height: 1064 },
        { type: "image", caption: "Three versions... can't make my mind up about anything", path: "/images/t_wear/t-wear-italy.jpg", width: 3152, height: 1064 },
        { type: "image", path: "/images/t_wear/t-wear-x-2.jpg", width: 1837, height: 2651 },
        { type: "image", caption: "Initial ideas sketched in Concepts", path: "/images/t_wear/IMG_0722_2.PNG", width: 2778, height: 1940 }
    ],
};
