...
const still_nothing: IEntry = {
    ...
    items: [
        {
            caption:
                "Not nearly as impressive when they're separated... I don't know what this first thing is, a gem or something maybe?",
        ...
        {
            caption:
                "Trying to understand and practice folds. I need waayyyy more of these.",
